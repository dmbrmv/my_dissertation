...
final_save = Path(f'{path_to_save}/more_gauges_14_03')
final_save.mkdir(exist_ok=True, parents=True)

gauge_file = gpd.read_file(
    './data/initial_gauges/great_db/more_gauges_14_03.gpkg')
...
concat_list.to_file(f'{res_folder}/ws_14_03_recalc.gpkg',
                    encoding='utf-8')
