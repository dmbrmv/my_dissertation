...
def simulation(data, params=[1., 0.1, 50., 0.5, 0.4, 0.05, 0.5, 2.,
                             3., 50., 1., 0., 2., 1., 0.005, 0.1]):
    '''
    ...
    parBETA, parCET, parFC, parK0, parK1, parK2, parLP, parMAXBAS,\
        parPERC, parUZL, parPCORR, parTT, parCFMAX, \
    ...
    Temp_mean = np.array([Temp[Temp.index.dayofyear == x].mean()
                         for x in range(1, 367)])
    # print(Evap.index)
    # b. correction of Evaporation daily values
    Evap = Evap.index.map(lambda x: (
        1+parCET*(Temp[x] - Temp_mean[x.dayofyear - 1]))*Evap[x])
...
def bounds():
    ...
    #          [0, 0.2] (usually 0.1)
    '''
    bnds = ((1, 6), (0, 0.3), (50, 700), (0.05, 0.99),
            (0.01, 0.8), (0.001, 0.15), (0.3, 1), (1, 3),
            (0, 6), (0, 100), (0.5, 2), (-2.5, 2.5),
            (0.5, 5), (1, 1.5), (0, 0.01), (0, 0.2))
    return bnds
