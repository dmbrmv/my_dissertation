...
def simulation(data, params):
    ...
    def SS1(t, C, D):
        ...
        Inputs:
           ...
           t: time-step
        Outputs:
           SS1: Values of the S curve for t
        """
        FI = t + 1
        if FI <= 0:
            SS1 = 0
    ...
    def SS2(t, C, D):
        ...
        Inputs:
           ...
           t: time-step
        Outputs:
           SS2: Values of the S curve for t
        """
        FI = t + 1
        if FI <= 0:
            SS2 = 0
    ...
    def UH1(C, D):
        """
        C Computation of ordinates of GR unit hydrograph UH1
...
def bounds():
    ...
    X7 : temperature which separates rain and snow fraction of precipitation
        [-1.5, 2.5]
    """
    bnds = ((0, 3000), (-10, 10), (0, 1000), (0, 20), (0, 1), (1, 10), (-1.5, 2.5))
    return bnds
